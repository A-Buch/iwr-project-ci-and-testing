...
#SBATCH --job-name=attrici_31_interpolation
...
####SBATCH --array=0-500 ###: memory limit exited
#SBATCH --cpus-per-task=4 ### 8 ##2 
...
export OMP_NUM_THREADS=4 ##8  # see: intern Cluster User Guide documentation.com, matches how many cpus-per-task we asked for
export SUBMITTED=1
