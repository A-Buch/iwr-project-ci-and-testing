...
#SBATCH --array=1   ###0-1000%500 ##: memory limit exited
...
#export OMP_NUM_THREADS=2 ##8  # see: intern Cluster User Guide documentation.com, matches how many cpus-per-task we asked for
#export SUBMITTED=1
